        ...
        <div>
            <div className="container" id="Contact">
              <div className="text-center">
                <h1>We’d Love to Hear <span className="text-color-update-2">From You</span></h1>
                <p className="text-color-update">Whether you’re curious about ONSmedico, a free treatment, or even press—we’re ready to answer any and all questions.</p>
              </div>
              <div className="row my-5 pb-5">
                ...
                <div className="col-md-8 col-12">
                  <div className="row">
                    ...
                    <div className="col-md-6 col-12">
                      <div>
                        <h1 className="text-color-update">North America (Toll Free)</h1>
                        <p>+1 888 515 9161</p>
                      </div>
                      <div>
